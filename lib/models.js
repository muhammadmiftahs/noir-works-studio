...
export const MODELS = [
  ...
  },
  {
    ...
    badgeColor: '#8E75FF',
    description:
      'Pilihan gratis (Free Tier). Sangat cepat, punya kemampuan vision bagus, dan ideal untuk penggunaan harian tanpa biaya.',
  ...
  },
  {
    ...
    badgeColor: '#4285F4',
    description:
      'Model Google paling cerdas di jalur gratis. Lebih teliti dari Flash, cocok untuk analisis metadata yang kompleks.',
    price: { input: 0, output: 0 },
  },
];
